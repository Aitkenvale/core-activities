                ...
                <div style={{ display: "flex", gap: "var(--space-2)" }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: activeByPersonId[r.personId] ? "var(--text)" : "var(--deep)",
                      fontSize: "0.75rem",
                      cursor: "pointer",
                    }}
                  >
                ...
                <div style={{ display: "flex", gap: "var(--space-2)" }}>
                  <button
                    ...
                    style={{
                      ...
                      background: cancelled ? "var(--disabled-bg)" : statuses[r.personId] === "present" ? "var(--green)" : "var(--card-bg)",
                      color: cancelled ? "var(--muted)" : statuses[r.personId] === "present" ? "var(--card-bg)" : "var(--green)",
                      fontSize: "0.75rem",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: cancelled ? "var(--disabled-bg)" : statuses[r.personId] === "absent" ? "var(--red)" : "var(--card-bg)",
                      color: cancelled ? "var(--muted)" : statuses[r.personId] === "absent" ? "var(--card-bg)" : "var(--red)",
                      fontSize: "0.75rem",
                      cursor: readOnly ? "default" : "pointer",
                      opacity: readOnly && !cancelled ? 0.6 : 1,
                    }}
